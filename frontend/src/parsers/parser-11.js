...
function peg$parse(input, options) {
  ...
  var peg$f3 = function(name, value) { return { type: 'string_field', field: name, value }; };
  var peg$f4 = function(name, value) { return { type: 'list_field', field: name, value: value }; };
  var peg$f5 = function(name, value) { return { type: 'number_field', field: name, value }; };
  var peg$f6 = function(op, number) { return { type: 'compare', op, value: number }; };
  var peg$f7 = function(type, value) { return { type: 'compare', op: type, value }; };
  ...
  var peg$f10 = function(digits) { return Number(digits.join('')); };
  var peg$f11 = function(chars) { return { type: 'term', value: chars.join('') }; };
  var peg$currPos = 0;
  var peg$savedPos = 0;
