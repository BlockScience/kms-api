        ...
        <div className={classes.inner}>
          <div className={classes.content}>
            ...
            <Text color='dimmed' mt='md'>
              A lightweight but powerful tool to find and organise knowledge
              objects. All made just for us!
            </Text>
            ...
            >
              <List.Item>
                <b>Search-based UX</b> – just hit <Code color='gray'>/</Code> to
                start searching. No knowledge required.
              </List.Item>
              <List.Item>
                <b>Powerful query system</b> – searches can be filtered, sorted,
                and grouped with both UI and text syntax.{' '}
