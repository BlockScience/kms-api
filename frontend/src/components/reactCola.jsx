...
const Layout = ({
  ...
  if (isNaN(width) || isNaN(height) || width <= 0 || height <= 0) {
    throw new Error(`Expected valid [width, height], encountered [${width}, ${height}].`)
  }
  ...
  const [_, mutateLayout] = useMutator(() => null)
  useEffect(() => {
  ...
  return <React.Fragment>{!!diagram && renderLayout(diagram)}</React.Fragment>
}
