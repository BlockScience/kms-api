export const parser = // Generated by Peggy 3.0.2.
  ...
  (function () {
    ...
    function peg$parse(input, options) {
      ...
      var peg$e16 = peg$classExpectation([' ', '\\', 't', '\\', 'n', '\\', 'r'], false, false)
      ...
      var peg$f4 = function (values) {
        return { type: 'values', values: [values[0], ...values[2].map((v) => v[3])] }
      }
      ...
      var peg$f9 = function (ranges) {
        return { type: 'ranges', ranges: ranges.map((r) => ({ min: r[0], max: r[2] })) }
      }
